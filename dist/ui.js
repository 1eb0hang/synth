...
export const getSynthControls = () => {
    var _a;
    const inputList = (_a = document.querySelector(".controls")) === null || _a === void 0 ? void 0 : _a.querySelectorAll("input");
    if (!inputList)
        throw new Error("Synth controls not initialized");
    const controlList = {};
...
const updateValueWithUI = (uiComponent, uiValue, audioSet) => {
...
//     for()
// }
export const setUpControlsEventLinsteners = (audio) => {
    if (!audio.isContextValid())
        throw new Error("Valid audio context not found");
    ...
    controlList.osc2Type.addEventListener("input", (e) => { updateValueWithUI(controlList.osc2Type, controlList.osc2Type.value, audio.setOsc2Type); });
